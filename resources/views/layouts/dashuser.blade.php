            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-book me-2"></i>Pemesanan</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/home" class="dropdown-item"> Tambah Pesanan Baru</a>
                            <a href="/rOrder" class="dropdown-item">Riwayat Pemesanan</a>
                        </div>
                    </div>
                </div>
            </nav>
